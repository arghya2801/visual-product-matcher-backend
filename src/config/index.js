...
export const CONVEX_DEPLOYMENT = process.env.CONVEX_URL || ""; // https://<your>.convex.cloud
...
export const CONFIG_WARNINGS = () => {
  ...
  if (!CONVEX_DEPLOYMENT) console.warn("Missing CONVEX_URL e.g. https://xxx.convex.cloud");
